    ...
    const whyUsJsx = (
        <>
            {whyUs.map((w, index) => {
                ...
                return (
                    <div key={index} className={` ${index % 2 == 0 ? 'justify-start  from-gray-400 to-indigo-900 bg-transparent bg-clip-text ' : ' justify-end ml-auto  from-gray-300  to-indigo-950 bg-transparent bg-clip-text'} flex flex-col md:flex-row justify-center items-center md:gap-8 md:w-1/2 md:outline outline-1 md:px-8 md:py-4 md:rounded-full drop-shadow-2xl px-2 py-2 grad `}>
