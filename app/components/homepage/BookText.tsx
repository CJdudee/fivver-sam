...
export default function BookText() {
  return (
    <>
      ...
      <div className="w-full  flex justify-evenly flex-col h-fit  md:h-3/5 md:py-0  ">
        <div className={`${robot.className} flex flex-col gap-1`}>
      ...
      <div className=" mt-6 pl-8 flex pb-4 md:pb-0">
        <Link
          href={"/trial"}
