...
export default function HomePageTop() {
  return (
    <div className="bg-white w-full md:w-4/5 mx-auto md:h-full rounded-xl flex flex-col-reverse lg:flex-row z-20 h-full  ">
      <div className="bg-white w-full h-full  lg:h-full pt-4 lg:w-[50%]  px-4  flex flex-col justify-center items-center z-20 rounded-l-xl ">
        <BookText />
      </div>
      <div className="bg-white w-full hidden  h-1/2 lg:h-full   lg:w-[50%]    py-4 md:py-4 px-12 md:px-32 lg:px-4 z-20 rounded-r-xl relative lg:flex ">
        {/* <BookPic /> */}
        <BookTwo />
      </div>
    </div>
