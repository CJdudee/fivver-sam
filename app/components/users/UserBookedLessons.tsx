              ...
              <div className="text-center w-full">
                ...
                <div className="flex flex-col items-center justify-evenly w-1/2 mx-auto outline outline-1 rounded-xl">
                  <div className="flex w-full">
                    ...
                    <p className="w-1/2 text-center bg-blue-400 rounded-tr-xl">{b.teacher.user.username}</p>
                  </div>
                  <div className="flex w-full">
                    <p className="w-1/2 text-center bg-blue-400 ">Email</p>
                    <p className="w-1/2 text-center bg-blue-400 ">{b.teacher.user.email != "" ? b.teacher.user.email : "No Email "}</p>
                  </div>
